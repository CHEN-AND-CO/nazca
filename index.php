                ...
                foreach ($params as $param) {
                    echo '<tr id="'.$param->getId().'">';
                        ...
                        echo '<td class="param-item">';
                            ...
                            echo '<div>';
                                echo '<button class="edit-button" onclickcasse="location.href=\'consultation.php?id=' . $param->getId() . '\';" id="' . $param->getId() . '">🖉</button>';
                                echo '<button class="delete-button" onclickcasse="if(confirm(\'Voulez vous supprimer ' . $param->getLibelle() . '?\')){location.href=\'action.php?action=del_param&id=' . $param->getId() . '\';}" id="' . $param->getId() . '">×</button>';
                            echo '</div>';
                        echo '</td>';
                    echo '</tr>';
                }
